...
# ------------------------------------------------------------
# Full eLeMeNt bootstrap:
# 48K environment + enabled 128K paging
# #10 -> page 0: BSROM
# #11 -> page 1: BSDOS
# #13 -> page 3: EasyCF
# then select external MB03+, switch it to MB02+ mode, and copy banks.
# ------------------------------------------------------------
code = bytearray()
...
# IDE mapping is intentionally not changed here.
# EasyCF EL_MB02_INIT sets m_zxi_002 = #03 immediately before the first ATA access.
